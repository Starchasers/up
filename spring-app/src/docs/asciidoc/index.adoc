...
include::build/generated-snippets/Upload/auto-section.adoc[]
'''
include::build/generated-snippets/GetUpload/auto-section.adoc[]
'''
...
'''
include::build/generated-snippets/LogOutAll/auto-section.adoc[]
'''
