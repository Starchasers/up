...
import NotFoundBox from '../components/blocks/NotFoundBox'
        ...
        <MainBox.Box>
          <Grid>
            ...
            <Grid.Unit size={{ xs: 1, md: 2 / 3 }}>
              <NotFoundBox>
                <NotFoundBox.Header>Not Found</NotFoundBox.Header>
                <NotFoundBox.Text>Oopsie woopsie,</NotFoundBox.Text>
                <NotFoundBox.Text>your desired page doesn't exist</NotFoundBox.Text>
                <NotFoundBox.Back
                  as={Link}
                  to='/'
                >
                  <NotFoundBox.Icon icon={faAngleLeft}/>
                  Go home
                </NotFoundBox.Back>
              </NotFoundBox>
            </Grid.Unit>
